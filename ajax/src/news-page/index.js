...
if (window.innerWidth >= 767) {
    ...
    window.addEventListener('scroll', function(e){
        if (window.scrollY > 700) {   
            var a  = document.getElementsByClassName("fixed-share-links");
            a[0].style.position = "Fixed";
            a[0].style.marginTop = "70x";
    
            var a  = document.getElementsByClassName("social-vertical-links");
            a[0].style.position = "Fixed";
            a[0].style.marginTop = "70x";
        }
        if (window.scrollY < 700) {
            ...
            a[0].style.marginTop = "auto !important";
