                                    ...
                                    <tr>
                                        <td className="player-row">
                                            <div className="player-pic">
                                                {<LazyLoad height={35}><img className="rounded" height="30" width="30" src={"https://d7d7wuk1a7yus.cloudfront.net/player-images/" + batsman.Id + ".png"} /></LazyLoad>}
                                            </div>
                                            <div>
                            ...
                            {this.state.TopBowler.map((result, i) => {
                                return (
                                    <tr>
                                        <td className="player-row">
                                            <div className="player-pic">
                                                {<LazyLoad height={35}><img className="rounded" height="30" width="30" src={"https://d7d7wuk1a7yus.cloudfront.net/player-images/" + result.Id + ".png"} /></LazyLoad>}
                                            </div>
                                            <div>
                                        ...
                                        <td claclassNamess="team-row-runs">{result.w}</td>
