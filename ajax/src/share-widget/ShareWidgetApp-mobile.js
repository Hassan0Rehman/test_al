...
class ShareWidgetAppMobile extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
      ...
      FacebookShareButton,
        ...
        return (
            <div className="tc-shares mobile-sticky-shares no-display">
                <div className="heart-circle-mob heart-like-action inline-block" onClick={this.onClick}>
...
export default ShareWidgetAppMobile;
